...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rbMinden = new javax.swing.JRadioButton();
        ...
        cbxKulonbozo = new javax.swing.JCheckBox();
        ...
        cbxAlap = new javax.swing.JMenuItem();
        ...
        buttonGroup1.add(rbMinden);
        rbMinden.setSelected(true);
        rbMinden.setText("Mindent mutat");
        ...
        cbxKulonbozo.setSelected(true);
        cbxKulonbozo.setText("Különböző számok");
        ...
        btnTippIndit.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(cbxKulonbozo)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnTippIndit, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        cbxAlap.setText("Alapállapot");
        cbxAlap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxAlapActionPerformed(evt);
            }
        });
        jMenu1.add(cbxAlap);
    ...
    private void btnGeneralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGeneralActionPerformed
         boolean selected = cbxKulonbozo.isSelected();
    ...
    private void cbxAlapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxAlapActionPerformed
        numMin.setValue(1);
        numMax.setValue(10);
        ...
        jTextArea1.setText("");
        jTextArea2.setText("");
        cbxKulonbozo.setSelected(false);
        jRadioButton1.setSelected(false);
        rbMinden.setSelected(true);
    }//GEN-LAST:event_cbxAlapActionPerformed

    private void btnTippInditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTippInditActionPerformed
        boolean mindentMutat = rbMinden.isSelected();
        Random rnd = new Random();
        int minValue = (int) numMin.getValue();
        int maxValue = (int) numMax.getValue();
        int kitalal = Integer.parseInt(txtVelSzam1.getText());
        int tipp1 = rnd.nextInt(maxValue - minValue + 1) + minValue;
        int tipp2 = rnd.nextInt(maxValue - minValue + 1) + minValue;
        int tipp3 = rnd.nextInt(maxValue - minValue + 1) + minValue;
    ...
    private javax.swing.JMenuItem cbxAlap;
    private javax.swing.JCheckBox cbxKulonbozo;
    ...
    private javax.swing.JRadioButton rbMinden;
